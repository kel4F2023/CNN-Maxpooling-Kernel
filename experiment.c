...
int main(){
    ...
    int m = 200;      // m is the number of rows per layer 
    int n = 200;      // n is the number of columns per layer 
    ...
    */
    for (int k = 32; k <= 672; k+= 32){    // k is the number of layers
